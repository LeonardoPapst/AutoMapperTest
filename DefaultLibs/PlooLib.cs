...
namespace AutoMapperTest
{
    public class PlooLib
    {
        ...
        // {
        //     GenericRequests.genericClient = new HttpClient();
        //     GenericRequests.genericClient.DefaultRequestHeaders.Clear();
        //     GenericRequests.genericClient.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
        //     GenericRequests.genericClient.DefaultRequestHeaders.Add("Connection", "keep-alive");
        // }
        // public static void InstantiateGenericConnection(string teamKey)
        // {
        //     GenericRequests.genericClient = new HttpClient();
        //     GenericRequests.genericClient.DefaultRequestHeaders.Clear();
        //     GenericRequests.genericClient.DefaultRequestHeaders.Accept.Add(new System.Net.Http.Headers.MediaTypeWithQualityHeaderValue("application/json"));
        //     GenericRequests.genericClient.DefaultRequestHeaders.Add("Connection", "keep-alive");
        //     GenericRequests.genericClient.DefaultRequestHeaders.Add("Team-Key", teamKey);
        // }
